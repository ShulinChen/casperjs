...
var domain = 'https://reflektive-demo.herokuapp.com';
...
var feedbackTest = function(test){
  ...
  casper.then(function(){
    ...
    casper.waitForSelector('#avatar-border', function(){
      ...
      }, 'One', 'the position profile is right!');
    });
...
//casper.options.clientScripts = ["jquery-2.1.3.js"];
...
casper.test.begin('PulseHR feedback test', 13, function(test){
  ...
  casper.start("https://reflektive-demo.herokuapp.com/", function(){  
    ...
    casper.then(function(){
      casper.evaluate(function(){
        ...
        $.mockjax({
          ...
          responseText: {"code":0,"token":null,"company":{"name":"Pulse","uuid":"a51588ea-b46f-4e44-bacc-ab07ed484f3e","isReviewShown":true,"isConstantFeedbackShown":true,"emailService":"GMAIL","isBranded":null,"brandBaseURL":"https://reflektive-demo.herokuapp.com/assets/branding/base-077b9e5cbb19876ee1871bc5bf5c00d1.css","brandStyleURL":null,"brandStyleEmailURL":null,"brandStylePluginURL":null,"reminderFreq":40,"allowChangeAvatar":null},"setting":{"uuid":"e334d9ba-7a23-4917-bdb7-b3404fe1490d","version":"4b3247","wallTitle":"Recognition","buttonTextPos":"Thanks","buttonTextNeg":"Save for 1x1","awardPointValues":"500,1000","rolloverTextPos":"Let [firstname] know that you appreciate their work by saying Thanks!","rolloverTextNeg":"Write a note for your next 1x1 with [firstname].","instructionsPos":"What did [firstname] do well?","instructionsNeg":"Describe what you want to discuss in your next 1x1 or Review with [firstname]","emailNewsLetter":"FALSE","rewardsOn":true,"emailThanks":true,"emailThanksManagerNotif":true,"emailThanksCongrats":false,"emailRedeem":true,"emailCommentThread":true,"emailCommentThanks":true,"hideGiveablePoints":false,"exchangeRate":1,"downloadL1":"Welcome to the Spotify Peer Bonus \u0026 Feedback Program","downloadL2":"At Spotify we believe employees need frequent feedback to improve. Now you can give feedback to your coworkers directly from your inbox.","silverValue":null,"goldValue":null,"pluginStars":"0,1,2","showCFGoals":true,"showCFGoalsWeight":true,"showCFGoalsComplete":true,"showCFGoalsHashtags":true,"tags":{"positive":[],"negative":[]}},"isManager":true,"profile":{"uuid":"82621b00-fd21-4d79-94db-dc2bc1ead0c7","version":"4b3247","name":"AdminTester","department":"Lead Division Architect","jobTitle":"UIX","location":"a","gender":"F","email":"admin@pulsehr.net","company":"Pulse","pictures":{"small":"https://d2kahs6as972iy.cloudfront.net/pulsehr.net/admin.jpg","medium":"https://d2kahs6as972iy.cloudfront.net/pulsehr.net/admin.jpg","large":"https://d2kahs6as972iy.cloudfront.net/pulsehr.net/admin.jpg"},"isManager":true,"constantFeedbackSetting":{"isConstantFeedbackShown":true,"isPointsGiver":true,"isNewUser":false,"timestamp":1421364066,"pointsGive":1500,"pointsReceived":250,"pointsReceivedTotal":350,"buttonPeer":"positive","buttonManager":"both"}}},
        
        });
        
        console.log("Here is the new value!!!");
        console.log($("#givable-points").text());
    ...
    // casper.thenOpen(feedbackURL('rbehera@pulsehr.net'), function(){
    casper.thenOpen("https://reflektive-demo.herokuapp.com/plugin/app/#email?from=rbehera@pulsehr.net", function(){
      casper.capture('temo.png');
